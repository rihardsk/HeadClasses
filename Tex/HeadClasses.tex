...
\sum_{\mathclap{\substack{x \in F, 
	...
	{\left\| s_{i}(x, (p_1, \ldots, p_k)) \right\|_p} \diamond \lambda
\]
then we say that $w$ belongs to the language, otherwise it does not.
We require the automaton to be built in such a way that this (possibly infinite) sum converges for every $w \in \Sigma$.
